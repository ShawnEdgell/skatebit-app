...
<div class="overflow-y-auto h-116 bg-base-200 p-2 rounded-box relative">

  {#if loading}
    <div class="absolute inset-0 flex items-center justify-center text-center p-4 z-10 bg-base-200/50">
